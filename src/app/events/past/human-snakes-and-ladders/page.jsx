...
const eventData = {
  ...
  description:
  "OpenContribute brought Human Snakes and Ladders, unique and one of the most sought after event in the flagship fest of , Riviera 22. With over 750+ registerstions, the event was a fun game that was played on a life sized Snakes and Ladders gameboard. Participants would face challenging and brain wrecking General questions if they landed on same spot as another participant or snake. It was one of the most successful events of OpenContribute until now.",
  childImgs: [

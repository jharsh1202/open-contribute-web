...
const ContactSection = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const sendToEmail = 'harshit120299@gmail.com';
    const emailContent = `Greetings OpenContribute Team!
      ...
      <div className="container px-5 py-5 mx-auto flex sm:flex-nowrap flex-wrap">
        <div className="lg:w-2/3 md:w-1/2 bg-gray-500 border-2 border-primary dark:border-darkprimary border-opacity-50 dark:bg-darkbackground rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
          <iframe
            ...
            marginWidth="0"
            scrolling="no"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3504.0985329396062!2d77.37819057450005!3d28.566803775700713!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cef9fe39fc573%3A0xe7f265d482e92231!2sF%20tower%20Silicon%20City%2C%20Sec%2076%2C%20Noida!5e0!3m2!1sen!2sin!4v1707096737268!5m2!1sen!2sin"
          ...
          <div className="bg-secondary dark:bg-darkbackground relative flex flex-wrap py-6 rounded shadow-md">
            ...
            <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
              ...
              <a className="text-primary dark:text-primary leading-relaxed">
                <a href="mailto:harshit120299@gmail.com">harshit120299@gmail.com</a>
              </a>
              ...
              <p className="text-primary dark:text-primary leading-relaxed">
                <a href="tel:+919752150070">+91 9716527979</a>
              </p>
            </div>
          </div>
        </div>

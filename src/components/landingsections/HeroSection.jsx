...
const HeroSection = () => {
  ...
  return (
    <section class="bg-background dark:bg-darkbackground">
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12" style={{ maxmarginLeft: '120px' }}>
            ...
            <a href="#contact" class="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700  rounded-full bg-secondary dark:bg-darksecondary dark:text-darktext hover:bg-highlight dark:hover:bg-darkhighlight" role="alert">
                ...
                <h1 class="py-3 text-gray-800 max-w-2xl mb-4 text-3xl font-bold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-darktext">Open Contributions  <span className='text-primary dark:text-darkprimary'>& </span> Transactions 
                <span className='text-primary dark:text-darkprimary'> for a </span>  <br/> Better  <span className='text-primary dark:text-darkprimary'>Tomorrow.</span></h1>
                <p class="pb-3 max-w-2xl mb-6 font-light text-text lg:mb-8 md:text-lg lg:text-xl dark:text-darktext">A transparent and reliable platform maximizing impactful contributions for a better future.</p>

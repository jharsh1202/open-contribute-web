...
const About1 = () => {
  return (
    <>
      <section className="bg-background dark:bg-darkbackground px-4 lg:px-36 pt-20 lg:pt-[60px] pb-12 lg:pb-[90px] overflow-hidden flex justify-center items-center">

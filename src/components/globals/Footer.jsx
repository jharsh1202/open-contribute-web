  ...
  return (
    <footer class="px-4 lg:px-36 text-text dark:text-darktext bg-background dark:bg-darkbackground body-font">
        ...
        <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
            ...
            <span class="ml-3 text-xl">OpenContribute</span>
            </a>
            <p class="text-sm text-gray-500 dark:text-darktext sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-800 sm:py-2 sm:mt-0 mt-4">© 2024 OpenContribute- 
            <a href="https://github.com/jharsh1202/open-contribute" class="text-gray-500 ml-1" target="_blank" rel="noopener noreferrer">Developed with ❤️ @OpenContribute</a>
            </p>
